...
| **[DE · TKG compensation](https://github.com/itsDNNS/docsight/wiki/Features-TKG-Compensation)** | Confirm complete-outage calendar days or calculate an independent missed-appointment claim, inspect the versioned TKG §58 calculation, and export an editable German claim letter locally; supporting telemetry remains an unconfirmed proposal |
