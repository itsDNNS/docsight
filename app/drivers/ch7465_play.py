...
Standalone driver for Play/UPC-branded CH7465LG-LC modems.
Split from the main CH7465 driver to avoid cross-contamination between firmware variants.

Key differences from the Vodafone/Connect Box variant:
...
class CH7465PlayDriver(ModemDriver):
    ...
    def __init__(self, url: str, user: str, password: str):
        ...
        self._finalizer = weakref.finalize(self, CH7465PlayDriver._cleanup, url, session)
    ...
    def _set_data(self, function: Action, data: dict) -> str:
        ...
        if 'fun' in data:
            raise ValueError("invalid data key in CH7465Play command")
        r = self._session.post(
